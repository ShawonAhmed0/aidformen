...
export default function Announcement({
    ...
    return (
        // Flows below the hero rather than overlapping it: the hero panel now
        // holds the overlap position on the photo's bottom edge, and two cards
        // cannot straddle the same seam.
